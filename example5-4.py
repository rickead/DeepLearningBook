...
if __name__ == "__main__":
    ...
    datasetFileName = 'data/synthetic_control.data'

    if not os.path.exists(datasetFileName):
        print("Download data set before continuing.")
        print("https://archive.ics.uci.edu/ml/datasets/synthetic+control+chart+time+series")
        print("Copy the synthetic_control.data to the \'data\' directory.")
        sys.exit(1)

    # fix random seed for reproducibility
    np.random.seed(123)

    dataset = loadtxt(datasetFileName)
    ...
    # Tried 'adam' optimizer and the Stochastic Gradient Descent 'sgd' optimizer.
    # The 'sgd' optimizer was used in the book, but the 'adam' optimizer provides better validation results.
    ...
    # Training set accuracy 0.86. Test set accuracy 0.86
